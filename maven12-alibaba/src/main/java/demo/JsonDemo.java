...
public class JsonDemo {
	...
	public static void main(String[] args) {
		...
		json2JavaBeanM4();// 将JSON文本转换为JavaBean的集合；转换为单纯的1个Object：parseObject(String text, Class<T>
							// clazz);
	...
	/**
	 * 将json数据转化为JSONArray: 注意：获取到JSONArray之后（我们这里只是获取到JSONArray而不是JavaBean的List集合）
